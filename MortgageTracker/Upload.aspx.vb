            ...
            If FileUpload1.PostedFile.ContentType = ExcelContentType Or FileUpload1.PostedFile.ContentType = Excel2010ContentType Then
                Try
                    ...
                    Using connection As New OleDbConnection(excelConnectionString)
                        ...
                        Dim Command As OleDbCommand = New OleDbCommand("Select * FROM [Status$]", connection)
                        ...
                        Using reader As DbDataReader = Command.ExecuteReader()
                            ...
                            'Dim sqlConnectionString As String = "Data Source=dv5peymjo7.database.windows.net;Initial Catalog=Status;Integrated Security=SSPI;User ID=AIBMortgageTracker;Password=X22vwvs42s;"

                            Dim sqlConnectionString As String = "Data Source=a7cry5jye1.database.windows.net;Initial Catalog=MortgagAJxWJlt5B;Persist Security Info=True;User ID=AIBMortgageTracker;Password=X22vwvs42s;Trusted_Connection=False;Encrypt=True;Connection Timeout=30;"
